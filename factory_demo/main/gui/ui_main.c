...
lv_obj_t *g_img_item = NULL;
lv_obj_t *g_lab_item = NULL;
lv_obj_t *g_led_item[5];
...
static void menu_prev_cb(lv_event_t *e)//上一页按钮事件
{
...
static void menu_next_cb(lv_event_t *e)//下一页按钮事件
{
    lv_led_off(g_led_item[g_item_index]);
    g_item_index++;
...
static void menu_enter_cb(lv_event_t *e)//进入界面事件
{
